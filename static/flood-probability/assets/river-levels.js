(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}(g.LFW || (g.LFW = {})).RiverLevelsPage = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
module.exports = {
  latlng: [
    52.9219,
    -1.4758
...
function RiverLevelsPage (options) {
  ...
  $toggleMap.click(function (e) {
    ...
    if ($mapContainer.hasClass('map-enlarge')) {
      ...
      $toggleMap.attr('title', 'Exit full screen')
      $html.css('overflow', 'hidden')
    } else {
      $toggleMap.html('Full screen <i class="fa fa-expand" alt="Full screen">')
      $toggleMap.attr('title', 'Full screen')
      $html.css('overflow', '')
    }
  ...
  this.testValues = stationsMap.testValues
  this.getPixelFromFeatureId = stationsMap.getPixelFromFeatureId
}

module.exports = RiverLevelsPage

},{"../center-point":1,"../stations-map":3}],3:[function(require,module,exports){
/* global $ */
...
function StationsMap (options) {
  ...
  var sourceStations = new ol.source.Vector({
    ...
    url: 'https://flood-warning-information.service.gov.uk/flood/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=flood:stations&maxFeatures=10000&outputFormat=application/json&srsName=EPSG:4326'
  })

  var sourceStationsWMSLayer = new ol.layer.Tile({
    source: new ol.source.TileWMS({
      params: {
        'LAYERS': 'flood:stations',
        'FORMAT': 'image/png'
      },
      url: 'https://flood-warning-information.service.gov.uk/flood/ows'
    }),
    minResolution: 800
  })
  ...
  var layers = [tileLayer, aerialLayer, stationLayer, sourceStationsWMSLayer]
  ...
  function getPixelFromFeatureId (featureId) {
    var feature = sourceStations.getFeatureById('stations.' + featureId)
    if (feature) {
  ...
  function showPopup (feature, pixel) {
    ...
    if (hoverId !== stationId && stationStatus !== 'closed') {
  ...
  function updateLegend () {
    if (view.getResolution() <= 200) {
      $('ul li.round', $legend).each(function (index) {
        $(this).removeClass('round')
        $(this).addClass('pin')
      })
    } else {
      $('ul li.pin', $legend).each(function (index) {
  ...
  view.on('change:resolution', updateLegend)
  ...
  function testValues () {
    return {
      ...
      roadVisible: tileLayer.getVisible(),
      aerialVisible: aerialLayer.getVisible()
  ...
  this.getPixelFromFeatureId = getPixelFromFeatureId
}

module.exports = StationsMap

},{"classlist-polyfill":5,"openlayers":6,"proj4":43,"raf":76}],4:[function(require,module,exports){
...
},{"performance-now":77}],77:[function(require,module,exports){
(function (process){
...
//# sourceMappingURL=river-levels.js.map
